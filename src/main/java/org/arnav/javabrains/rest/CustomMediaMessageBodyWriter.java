...
public class CustomMediaMessageBodyWriter implements MessageBodyWriter<Date>{

	@Override
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		// Checks the Type if the type that is passed is a Date, then returns true else false
		System.out.println("In Short Date isWriteable");
...
//		mediaType.APPLICATION_JSON;
		System.out.println("In Short Date writeTo");
